                        ...
                        <div class="row">
                            <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" HorizontalAlign="NotSet" LoadingPanelID="RadAjaxLoadingPanel1">
                                <telerik:RadGrid ID="RadGridListPO" runat="server"
                                    ...
                                    AllowSorting="True" Skin="Bootstrap" CellSpacing="-1"
                                    ...
                                    <MasterTableView DataSourceID="SqlDataSourceSalesOrderLine" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="no_so" ReadOnly="True" 
                                                ...
                                                HeaderStyle-Width="200px" FilterCheckListEnableLoadOnDemand="true"></telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="no_po" ReadOnly="True" HeaderText="Nomor PO" 
                                                SortExpression="no_po" UniqueName="no_po" 
                                                FilterControlAltText="Filter no_po column" 
                                                HeaderStyle-Width="190px" FilterCheckListEnableLoadOnDemand="true"></telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="date_order" ReadOnly="True" HeaderText="Tanggal PO" 
                                                ...
                                                HeaderStyle-Width="120px" EnableHeaderContextMenu="true">
                                            ...
                                            <telerik:GridBoundColumn DataField="date_order" ReadOnly="True" HeaderText="Tahun PO" 
                                                ...
                                                DataType="System.String" FilterControlAltText="Filter date_order column" 
                                            ...
                                            <telerik:GridBoundColumn DataField="customer" ReadOnly="True" 
                                                ...
                                                HeaderStyle-Width="300px" FilterCheckListEnableLoadOnDemand="true"></telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="site_id_customer" ReadOnly="True" 
                                                ...
                                                HeaderStyle-Width="150px" FilterCheckListEnableLoadOnDemand="true"></telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="project_id_prasetia" ReadOnly="True" 
                                                ...
                                                HeaderStyle-Width="180px" FilterCheckListEnableLoadOnDemand="true"></telerik:GridBoundColumn>
                                            ...
                                            <telerik:GridBoundColumn DataField="nilai_project" HeaderText="Nilai Project" 
                                                ...
                                                AllowFiltering="false" EnableHeaderContextMenu="false"></telerik:GridBoundColumn>
                                            ...
                                            <telerik:GridBoundColumn DataField="count_bast" ReadOnly="True" 
                                                ...
                                                HeaderStyle-Width="150px" EnableHeaderContextMenu="false" AllowFiltering="false"></telerik:GridBoundColumn>                                            
                                            <telerik:GridBoundColumn DataField="count_bast_mandatory" ReadOnly="True" 
                                                ...
                                                HeaderStyle-Width="150px" AllowFiltering="false" EnableHeaderContextMenu="false"></telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="count_bast_status" ReadOnly="True" 
                                                ...
                                                HeaderStyle-Width="150px" AllowFiltering="false" EnableHeaderContextMenu="false"></telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="check_status_po" ReadOnly="True" 
                                                HeaderText="PO Filter" SortExpression="check_status_po" 
                                                UniqueName="check_status_po" FilterControlAltText="Filter check_status_po column"
                                                HeaderStyle-Width="150px" AllowFiltering="true" EnableHeaderContextMenu="true" FilterCheckListEnableLoadOnDemand="true"></telerik:GridBoundColumn>
                                        </Columns>
                                    </MasterTableView>
                                </telerik:RadGrid>
